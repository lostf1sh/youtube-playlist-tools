import type { YouTubeClient } from '../src/lib/youtube';

export const createFakeYouTubeClient = (itemCount = 6): YouTubeClient => {
  ...
  return {
    ...
    async *iteratePlaylistVideoIds(_playlistId: string, maxItems: number) {
